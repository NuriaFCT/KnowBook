                    ...
                    @if(count($posts)>0)
                            ...
                            @foreach ($posts as $post)
                                    <table class="rounded overflow-hidden shadow-lg mb-4" style="background-color: #f7e5d8; width:100%; height:300px">
                                        ...
                                        <!--Segundo bucle para mostrar el numero de likes-->
                                        <tr>
                                            
                                            <td>
                                            <button id="myajax" onclick="prueba()"> 
                                        ...
                                        <div class="flex flex-wrap justify-center">
                                          ...
                                          <div class="h-screen flex flex-col items-center justify-center border-none">
                                                <p class="text-xl mb-3 ">
                                                    ¡Comienza a <strong>seguir</strong> a otras cuentas para visualizar su contenido en esta pestaña!
                                                </p>
                                          </div>
                    @endif      
                </div>
