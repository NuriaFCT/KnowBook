        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('posts.updateComment', $comment->id) }}" method="GET" enctype="multipart/form-data">
                        @csrf
                        <div>                 
                            ...
                            <div class="mt-4">
                                ...
                                <textarea id="text" class="block mt-1 w-full" type="text" name="text" required autofocus>{{$comment->text}}</textarea>
                            </div>
                            <div>
